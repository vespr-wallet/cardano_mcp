...
describe('fetchWalletDetailed', () => {
  const validAddress = 'addr1qy8ac7qqy0vtulyl7wntmsxc6wex80gvcyjy33qffrhm7sh927ysx5sftuw0dlft05dz3c7revpf7jx0xnlcjz3g69mq4afdhv';
  ...
  describe('error handling', () => {
    it('throws VesprApiError on 400', async () => {
      ...
      await expect(fetchWalletDetailed(validAddress))
